...
export default function PackageDetailsPage({ params }) {
  ...
  let relatedPackages = packages.filter(
    (p) =>
      p._id !== pkg?._id &&
      (p.category === pkg?.category || p.destination === pkg?.destination),
  );
  ...
  const commonFaqs = [
    {
      ...
      answer:
        "You can book by calling us directly or sending a WhatsApp message. We require a small advance payment to confirm your booking.",
    },
    {
      question: "Is the guide fee included?",
      answer:
        "Guide charges are included for groups of 12 or more people. For smaller groups (<12), an extra fee of ₹1000/day applies.",
    },
    {
      question: "Can I customize this itinerary?",
      answer:
        "Absolutely! We specialize in custom tours. Contact us to add or remove destinations like Omkareshwar or Maheshwar.",
    },
  ];
  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta
          name="keywords"
          content={`${pkg.name}, ${pkg.destination} tour package, Ujjain tour cost, Mahakal darshan package`}
        />
              ...
              {pkg.images && pkg.images.length > 1 && (
                <div className="grid grid-cols-4 gap-3 mb-10">
                  {pkg.images.slice(1, 5).map((image, index) => (
                    <div
                      key={index}
                      className="relative h-20 md:h-24 rounded-xl overflow-hidden cursor-pointer border-2 border-transparent hover:border-primary transition-all"
                    >
                      <Image
                        src={image.url}
                    ...
                    <button
                      onClick={() => {
                        ...
                        navigator.clipboard.writeText(text).then(() => {
                          ...
                          alert(
                            "Package details copied to clipboard! You can now paste it in Instagram.",
                          );
                        });
                      }}
                  ...
                  <div className="p-6 flex flex-col gap-2">
                    ...
                    <div className="space-y-3 text-gray-700">
                      {pkg.status !== false ? (
                        ...
                        <button
                          disabled
                          className="w-full bg-gray-300 text-white font-bold py-3.5 rounded-xl cursor-not-allowed"
                        >
                          Sold Out
                        </button>
                      )}
                ...
                <div className="flex flex-col gap-6 md:w-1/2">
                    ...
                    <div className="flex gap-3 items-start">
                      ...
                      <div>
                        <p className="font-semibold text-sm text-gray-900">
                          Verified Taxi & Hotels
                        </p>
                        <p className="text-xs text-gray-500">
                          We use only clean cabs & top-rated stays.
                        </p>
                      </div>
                    </div>
                    <div className="flex gap-3 items-start">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500">
                          On-call support throughout your trip.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-gray-900 text-white rounded-2xl p-8 text-center">
                    ...
                    <p className="text-gray-400 text-sm mb-4">
                      We can customize this package for your family.
                    </p>
                    <Link
                      href="/contact"
                      className="text-primary font-semibold hover:text-white transition-colors underline"
                    >
