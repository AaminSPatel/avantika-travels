...
export default function AdminDashboard() {
  ...
  timeAgo,  places, packages, blogs, contacts, reviews
  } = useSite()
 ...
 if (loading) {
  ...
  {/* Content Overview */}
          <div className="lg:col-sp my-4 bg-white rounded-xl shadow-md p-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
         {/* Recent Activity */}
            <div className="bg-white rounded-xl flex-1 shadow-md p-6">
              <div className="flex items-center justify-between mb-6">
        ...
        <div className="mt-8 bg-white rounded-xl shadow-md p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <button
              ...
              className="flex items-center justify-center p-4 bg-pink-50 text-pink-600 rounded-lg hover:bg-pink-100 transition-colors"
            >
